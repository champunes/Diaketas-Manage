 ...
 *
 */
public class ControladorC_Empresa implements Controlador, ActionListener {
    ...
    public static ControladorC_Empresa getInstance(VentanaPrincipal pvista) {
    ...
    public ControladorC_Empresa(VentanaPrincipal vista) {
        this.vista = vista;
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getActionCommand().equalsIgnoreCase("salvar")) {
