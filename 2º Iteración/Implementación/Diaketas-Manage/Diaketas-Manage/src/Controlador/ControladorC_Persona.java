 ...
 **
 */
public class ControladorC_Persona implements Controlador, ActionListener{
    ...
    public static ControladorC_Persona getInstance(VentanaPrincipal pvista) {
    ...
    public ControladorC_Persona(VentanaPrincipal vista) {
        this.vista = vista;
    }
    ...
    public boolean cambiarC_PersonaSocio(C_Persona tempP, String usuarioN) {
        ...
        // if usuarioValido 
        String contrasena = ControladorVoluntarios.genContrasena();
