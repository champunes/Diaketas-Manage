...
public class ControladorAyuda2{

    /** PATRON DE DISEÑO SINGLETON */
    
    private static ControladorAyuda2 instancia = null;

    public static ControladorAyuda2 getInstance(VentanaPrincipal2 pvista){

            if(instancia == null)
                    instancia = new ControladorAyuda2(pvista);
            return instancia;
     ...
     */
    private ControladorAyuda2(VentanaPrincipal2 pvista){
